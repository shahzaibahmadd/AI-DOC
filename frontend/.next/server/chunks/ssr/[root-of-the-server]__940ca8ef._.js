...
[__TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
"use client";
;
;
;
...
function ChatPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$auth$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getToken"])();
        if (!token) router.push("/login");
        fetchChats();
    }, []);
    const fetchChats = async ()=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get("/chats", {
            headers: {
                Authorization: `Bearer ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$auth$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getToken"])()}`
            }
        });
        setChats(res.data);
    };
    ...
    const openChat = async (chat)=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get(`/chats/${chat._id}`, {
            headers: {
                Authorization: `Bearer ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$auth$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getToken"])()}`
            }
        });
    ...
    const sendMessage = async ()=>{
        ...
        try {
            let reply;
            if (!selectedChat || !selectedChat._id) {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post("/chats/new", {
                    message: input
                }, {
                    headers: {
                        Authorization: `Bearer ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$auth$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getToken"])()}`
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post(`/chats/${selectedChat._id}/message`, {
                    message: input,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__940ca8ef._.js.map