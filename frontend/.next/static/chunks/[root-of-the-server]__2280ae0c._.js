...
"[project]/frontend/components/ChatWindow.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const handleSubmit = async (e)=>{
    ...
    try {
        ...
        if (!chatId) {
            ...
            const res = await axios.post("".concat(API_BASE, "/chats/new"), {
                message: input
            }, {
                headers: {
                    Authorization: "Bearer ".concat(token)
            ...
            const res = await axios.post("".concat(API_BASE, "/chats/").concat(chatId, "/message"), {
                message: input,
                sessionId: chatId
            }, {
                headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2280ae0c._.js.map