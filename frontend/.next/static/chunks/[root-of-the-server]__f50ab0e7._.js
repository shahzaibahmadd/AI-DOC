...
;
;
// Load LiquidEther only on the client to avoid heavy SSR bundle and defer initialization
...
function Dashboard() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // client-only & sizing state for the heavy background
    ...
    // Defer showing the heavy background until we're on the client and the browser is idle.
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            setIsClient(true);
            const MIN_WIDTH = 900; // only show background on wider screens
            const scheduleShow = {
                "Dashboard.useEffect.scheduleShow": ()=>{
                    const shouldShow = window.innerWidth >= MIN_WIDTH;
                    if ('requestIdleCallback' in window) {
                        requestIdleCallback({
                            "Dashboard.useEffect.scheduleShow": ()=>setShowBackground(shouldShow)
                        }["Dashboard.useEffect.scheduleShow"], {
                            timeout: 1500
                        });
                    } else {
                        // fallback - small timeout so we don't block first paint
                        setTimeout({
                            "Dashboard.useEffect.scheduleShow": ()=>setShowBackground(shouldShow)
                        }["Dashboard.useEffect.scheduleShow"], 250);
                    }
                }
            }["Dashboard.useEffect.scheduleShow"];
            scheduleShow();
            const onResize = {
                "Dashboard.useEffect.onResize": ()=>setShowBackground(window.innerWidth >= MIN_WIDTH)
            }["Dashboard.useEffect.onResize"];
            window.addEventListener('resize', onResize);
            return ({
                "Dashboard.useEffect": ()=>window.removeEventListener('resize', onResize)
            })["Dashboard.useEffect"];
        }
    }["Dashboard.useEffect"], []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$Layout$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "relative",
            children: [
                isClient && showBackground && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LiquidEther, {
                        ...
                        // reduced interaction/force to lower GPU work
                        mouseForce: 12,
                        cursorSize: 60,
                        isViscous: false,
                        viscous: 12,
                        ...
                        // we also pass a computed resolution to help clamp DPR impact
                        resolution: 0.35,
                        isBounce: false,
                        // keep demo but lower intensity/speed
                        autoDemo: true,
                        autoSpeed: 0.4,
                        autoIntensity: 1.8,
...
_s(Dashboard, "VJs2dVOUTrYjhb5dRB2joVFZ5wc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f50ab0e7._.js.map