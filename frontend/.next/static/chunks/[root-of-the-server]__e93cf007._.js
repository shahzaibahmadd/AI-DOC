...
"[project]/fyp/pages/login.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Login() {
    ...
    const onSubmit = async (data)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("/auth/login", data);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$fyp$2f$lib$2f$auth$2e$js__$5b$client$5d$__$28$ecmascript$29$__["setToken"])(res.data.token);
            router.push("/dashboard");
        } catch (err) {
            var _err_response_data, _err_response;
            alert(((_err_response = err.response) === null || _err_response === void 0 ? void 0 : (_err_response_data = _err_response.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.message) || "Invalid credentials");
        }
    };
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/fyp/pages/login.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/login";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/fyp/pages/login.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/fyp/pages/login\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/fyp/pages/login.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__e93cf007._.js.map